...
def create_paynow_qr():
    ...
    try:
        ...
        # Make the POST request, bypassing SSL certificate verification.
        response = requests.post(third_party_url, data=form_data, headers=headers, timeout=15, verify=False)
